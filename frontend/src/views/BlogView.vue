...
<template>
  <div class="blog-shell"><BlogHeader /><main class="blog-main" :class="{ 'compact-main': section }">
    <template v-if="!section">
      <section class="blog-intro"><div><span class="page-index">INDEX / 001</span><h1>{{ site.blogTitle }}</h1></div><p>{{ site.blogIntro }}<small class="api-mode">{{ apiMode }}</small></p></section>

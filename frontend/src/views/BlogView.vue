...
const routeAuthor = computed(() => getAuthor(route.params.id));
...
<template>
  <div class="blog-shell"><BlogHeader /><main class="blog-main" :class="{ 'compact-main': section }">
    <template v-if="!section">
      <section class="blog-intro"><div><span class="page-index">INDEX / 001</span><h1>技术笔记<br />与长期观察</h1></div><p>{{ site.heroSummary }}<small class="api-mode">{{ apiMode }}</small></p></section>

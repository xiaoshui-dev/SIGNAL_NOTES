...
<template>
  <main class="landing-page">
    ...
    <footer class="landing-footer"><BrandLogo light /><p>关于 AI、系统与数字世界的独立技术博客。</p><div><RouterLink to="/blog">进入博客</RouterLink><RouterLink to="/blog/about">关于</RouterLink><a href="mailto:hello@signal-notes.local">联系</a></div><small>© 2026 Signal Notes. Hero photo from Unsplash.</small></footer>
  </main>
</template>

...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    @Override protected boolean shouldNotFilter(HttpServletRequest request) { String path=request.getRequestURI(); return !"POST".equals(request.getMethod()) || !(path.equals("/api/comments")||path.equals("/api/contact")||path.equals("/api/subscriptions")); }
